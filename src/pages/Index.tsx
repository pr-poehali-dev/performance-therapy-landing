        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="text-center">
            <div className="animate-fade-in">
              <div className="inline-block px-3 py-1 md:px-4 md:py-2 bg-primary/20 border border-primary/50 rounded-full mb-4 md:mb-6 animate-shimmer bg-[length:200%_100%] bg-gold-shimmer">
                <span className="text-primary font-semibold text-base md:text-lg tracking-wider leading-tight">✨ Психологический актёрский курс</span>
              </div>
