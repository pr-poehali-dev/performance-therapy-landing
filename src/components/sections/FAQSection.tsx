...
const faqs = [
  ...
  },
  {
    ...
    answer: "Курс оплачивается помесячно. Первый платёж — 3 сентября, затем — 3 октября, 3 ноября и 3 декабря. Оплата может производиться наличными, переводом или банковской картой."
  },
  {
