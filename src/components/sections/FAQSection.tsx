...
const faqs = [
  ...
  },
  {
    ...
    answer: "В группе 8 человек. Это оптимальное количество для индивидуального подхода к каждому участнику и создания доверительной атмосферы."
  },
  {
    question: "Что делать, если я пропущу занятие?",
    answer: "Пропущенное занятие можно будет отработать до конца курса индивидуально или в малой группе."
  },
  {
    question: "Как проходят занятия?",
    answer: "Занятия проходят 2 раза в неделю по 2 часа. Курс включает групповые арт-терапевтические сессии и индивидуальные сессии с психологом."
  },
  {
  ...
  },
  {
    ...
    answer: "Курс оплачивается помесячно. Первый платёж — 28 сентября, затем — 28 октября, 28 ноября и 28 декабря. Оплата может производиться наличными, переводом или банковской картой."
  },
  {
